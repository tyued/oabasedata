<template>
  <div class="app-container calendar-list-container">
                  ...
                  <div class="con">
                    ...
                    <div class="ryCon">
                        <div class="navbarbox clear">
                            <div class="item"><span>部门</span></div>
                        </div>
                        <div class="cycon">
                            <el-tree ref="xzsprtree" :data="bmsj" :filter-node-method="filterNode" accordion
                                  node-key="treeId" @check-change="handleCheckChange" show-checkbox
      ...
      <el-dialog width="600px" title="选择" :visible.sync="dialogxzspjs" append-to-body>
        <!--<div class="transferBox">-->
          <!--<div class="transferpar">-->
            <!--<div class="title">选择：</div>-->
            <!--<div class="con">-->
                ...
                <!--<div class="ryCon">-->
                    <!--<div class="cycon">-->
                        <!--<el-tree :data="jssj" :props="props"></el-tree>-->
                    <!--</div>-->
                <!--</div>-->
            <!--</div>-->
          <!--</div>-->
          <!--<div class="transferpar">-->
              ...
              <!--<div class="con">-->
                  <!--<div class="ryCon">-->
                    <!--<div>-->
                        <!--<el-tag v-for="tag in bzjs" :key="tag.name" @close="handleClose_tag(tag)" closable>{{tag.name}}</el-tag>-->
                    <!--</div>-->
                  <!--</div>-->
              <!--</div>-->
          <!--</div>-->
