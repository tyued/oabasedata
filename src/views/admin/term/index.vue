    ...
    <div class="app-container calendar-list-container">
        ...
        <el-dialog :title="textMap[dialogStatus]"  :visible.sync="dialogFormVisible" width="700px" >
            <el-form :model="form" ref="form" label-width="100px">
                <el-form-item label="学期名称" prop="xqmc" :rules="[{ required: true, message: '学期名称不能为空'}]">
                    <el-input v-model="form.xqmc" placeholder="请输入学期名称"></el-input>
                </el-form-item>
                <el-form-item label="显示顺序" prop="xssx"  :rules="[{ required: true, message: '显示顺序不能为空'}]" style="width:50%">
                    <el-input v-model="form.xssx" placeholder=""></el-input>
                </el-form-item>
            </el-form>
