    ...
    <div class="app-container calendar-list-container">
        ...
        <el-dialog :title="textMap[dialogStatus]"  :visible.sync="dialogFormVisible" width="600px" >
            <el-form :model="form" ref="form" label-width="110px">
                <el-row :gutter="18">
                    <el-col :span="12">
                        <el-form-item label="场地名称" prop="cdmc" :rules="[{ required: true, message: '场地名称不能为空'}]">
                            <el-input v-model="form.cdmc" placeholder=""></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="场地简称"  prop="cdjc" :rules="[{ required: true, message: '场地简称不能为空'}]">
