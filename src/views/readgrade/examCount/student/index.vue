  ...
  <div class="app-container examCount">
      ...
      <el-form :model="ruleForm" :rules="rule" ref="ruleFormQS" label-width="100px">
        ...
        <el-col style="width: 600px;">
          <el-form-item label="姓名">
            <el-input size="medium" style="width: 200px;" maxlength="20" v-model="searchName" placeholder="请输入姓名"></el-input>
    ...
    <el-row style="margin: 10px 0;">
      <el-table :data="tableData" border style="width: 100%;" empty-text="没有找到符合条件的记录~">
        ...
        <el-table-column prop="ExCount" label="考试次数"></el-table-column>
        <el-table-column prop="ExScore" label="考试成绩"></el-table-column>
      </el-table>
    </el-row>
    <el-row>
...
export default {
  ...
  methods: {
    ...
    handleDataOut(formName) {
      window.open(
        `http://newreadlevel.91sst.com.cn/home/GetCommentListByStudent?schoolcode=${
          this.xxdm
        ...
        }&ExcelName=考试统计-按学生统计-${formatDate()}`
      );
    },
