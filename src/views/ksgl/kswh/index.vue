          ...
          <el-card shadow="always" >
            ...
            <div style="height: 40px;margin-top: 10px;">
              <el-row style="float:left;">
                <el-button @click="toPage(item,0,'0')" size="small" icon="iconfont icon-el-icon-config" plain type="primary">考试设置
                </el-button>
                &nbsp;&nbsp;是否智能排考&nbsp;
                <el-switch v-model="item.pkfs===1" @change="setStateValue($event,0,item.jlid)"></el-switch>
                &nbsp;&nbsp;录入状态&nbsp;
                <el-switch v-model="item.lrzt===0" @change="setStateValue($event,1,item.jlid)"></el-switch>
                &nbsp;&nbsp;是否复审&nbsp;
                <el-switch v-model="item.sffs===0" @change="setStateValue($event,2,item.jlid)"></el-switch>
              </el-row>
    ...
    methods: {
      getKswhList() {
        ...
        /*  this.list.forEach(item => {
            this.value2.push({ id: item.jlid, pkfs: item.pkfs === 1 }) // 设置录入状态
