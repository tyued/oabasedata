        ...
        <el-dialog :title="textMap[dialogStatus]"  :visible.sync="dialogFormVisible" width="600px" >
            <el-form :model="form" ref="form" label-width="100px">
                <el-row :gutter="15">
                    ...
                    <el-col :span="12">
                        <el-form-item label="班级名称" prop="bj"  :rules="[{ required: true, message: '班级名称不能为空'}]">
                            <el-input v-model="form.bj" placeholder=""></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>        
                <el-row :gutter="15">
    ...
    methods:{
        ...
        getMessage(){
            ...
            getXXMess(this.xxdm).then(response => {
                this.bjkind = response.data.bjlx;
            })
            teacherpage(this.all_listQuery).then(response => {
                var teachall = response.data.rows;
                for(var i=0; i<teachall.length;i++){
