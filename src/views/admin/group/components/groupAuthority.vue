<template>
    <el-row>
      ...
      <el-col :span="8" style='margin-top:15px;' >
        ...
        <el-tree class="filter-tree" style="height:500px; overflow:auto" :node-key="getTreeNodeKey" :data="treeData" show-checkbox node-key="id" highlight-current :props="defaultProps" :filter-node-method="filterNode" ref="menuTree" @node-click="getNodeData" default-expand-all>
        </el-tree>
