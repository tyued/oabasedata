...
<script>
  ...
  import { getAll,saveaddkcxx ,newPicture } from 'api/xkxt/kcxxManager/index'
...
//上传图片成功
      ...
      getTea(param){
        ...
        getAll(param).then(response => {//获取所有列表信息
          ...
          let   dqxnxq=response.dqxnxq[0];//当前学年学期和学习时间
          this.skksrq=dqxnxq.xxkssj;
          this.skjsrq=dqxnxq.xxjssj;
